(() => {
  ...
  var t = function(e, t, n, o) {
    ...
    c = new(function() {
      function e() {
        ...
        }, this.doNothing = function() {}, this.getUser = function() {
      ...
      return e.prototype.enqueue = function(e, t, n, o) {
        ...
        for (var e = this, t = function() {
            ...
            else console.error("%cPOKI:%c cannot execute ".concat(a), "font-weight: bold", "")
  ...
  if (window.PokiSDK = {
    ...
    try {
      ...
      u || (u = crypto.randomUUID(), localStorage.setItem("poki_events_user_id", u));
      var s = o("game_id"),
        l = o("game_version_id");
      if (!s || !l) throw 1;
      ...
      window.PokiSDK.measure = function(e, t, n) {
        ...
        function(e, t, n) {
          return "game" === e && "loading" === t && "start" === n || "game" === e && "loading" === t && "complete" === n || "game" === e && "launch" === t && "" === n || "tutorial" === e && "start" === t && "" === n || "tutorial" === e && "complete" === t && "" === n || "action" === e && "first" === t && "" === n || !("progress" !== e || "start" !== t || !f(n)) || !("progress" !== e || "complete" !== t || !f(n)) || !("progress" !== e || "fail" !== t || !f(n)) || "rewarded" === e && "visible" === t || "rewarded" === e && "click" === t || "rewarded" === e && "start" === t || "rewarded" === e && "complete" === t || "midroll" === e && "start" === t || "midroll" === e && "complete" === t || "custom" === e
        }(e, t = void 0 === t ? "" : "".concat(t), n = void 0 === n ? "" : "".concat(n)) && (window.pokiMeasureBuildin = !0, fetch("https://t.poki.io/game-event", {
          method: "POST",
          headers: {
  ...
  var p = function() {
      var e = window.pokiSDKVersion || o("ab") || "5192938ea27c3f4813a053fa9db0c75563ec3280",
  ...
  g.setAttribute("src", p), g.setAttribute("type", "text/javascript"), g.setAttribute("crossOrigin", "anonymous"), g.onload = function() {
    return c.dequeue()
