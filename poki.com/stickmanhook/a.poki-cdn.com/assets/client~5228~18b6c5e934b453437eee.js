  ...
  [5228], {
    45228: r => {
      ...
      r.exports = function() {
        ...
        for (var c, a, i = function(r) {
            if (null == r) throw new TypeError("Object.assign cannot be called with null or undefined");
            return Object(r)
          }(r), s = 1; s < arguments.length; s++) {
          for (var f in c = Object(arguments[s])) t.call(c, f) && (i[f] = c[f]);
          if (e) {
            a = e(c);
            for (var O = 0; O < a.length; O++) n.call(c, a[O]) && (i[a[O]] = c[a[O]])
          }
        }
        return i
      }
...
//# sourceMappingURL=client~5228~18b6c5e934b453437eee.js.map