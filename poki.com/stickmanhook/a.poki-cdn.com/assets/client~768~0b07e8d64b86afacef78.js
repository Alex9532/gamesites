  ...
  [768], {
    33237: (e, n, t) => {
      ...
      var r, i = -1,
          ...
          n = n || {},
            function(e, n) {
              n = n || {}, b((function() {
                ...
                a && (t = f(e, i, S, n.reportAllChanges), o((function(r) {
                  i = s("FCP"), t = f(e, i, S, n.reportAllChanges), l((function() {
              ...
              var t, r = s("CLS", 0),
                ...
                h = u("layout-shift", c);
              h && (t = f(e, r, T, n.reportAllChanges), d((function() {
                c(h.takeRecords()), t(!0)
              })), o((function() {
                i = 0, r = s("CLS", 0), t = f(e, r, T, n.reportAllChanges), l((function() {
                  return t()
                }))
              })), setTimeout(t, 0))
            })))
        ...
        k = function(e) {
          e.forEach((function(e) {
            e.interactionId && (w = Math.min(w, e.interactionId), L = Math.max(L, e.interactionId), C = L ? (L - w) / 7 + 1 : 0)
          }))
        },
        A = function() {
        ...
        P = function() {
          "interactionCount" in performance || r || (r = u("event", k, {
            type: "event",
            buffered: !0,
            durationThreshold: 0
          }))
          ...
          if (N.forEach((function(n) {
            ...
            if (t || O.length < 10 || e.duration > n.latency) {
              if (t) e.duration > t.latency ? (t.entries = [e], t.latency = e.duration) : e.duration === t.latency && e.startTime === t.entries[0].startTime && t.entries.push(e);
                ...
                I.set(r.id, r), O.push(r)
              }
              O.sort((function(e, n) {
                return n.latency - e.latency
              })), O.length > 10 && O.splice(10).forEach((function(e) {
        ...
        H = function(e) {
          var n = self.requestIdleCallback || self.setTimeout,
            t = -1;
          return e = h(e), "hidden" === document.visibilityState ? e() : (t = n(e), d(e)), t
        },
        K = [200, 500],
        q = function(e, n) {
          "PerformanceEventTiming" in self && "interactionId" in PerformanceEventTiming.prototype && (n = n || {}, b((function() {
            var t;
            P();
            var r, i = s("INP"),
              a = function(e) {
                H((function() {
                  e.forEach(M);
                  var n = function() {
                    var e = Math.min(O.length - 1, Math.floor((A() - D) / 50));
                    return O[e]
                  }();
            ...
            r = f(e, i, K, n.reportAllChanges), c && (c.observe({
              type: "first-input",
              buffered: !0
            }), d((function() {
              a(c.takeRecords()), r(!0)
            })), o((function() {
              D = A(), O.length = 0, I.clear(), i = s("INP"), r = f(e, i, K, n.reportAllChanges)
            })))
          })))
        },
        x = [2500, 4e3],
        ...
        j = function(e, n) {
          n = n || {}, b((function() {
            ...
            if (p) {
              t = f(e, i, x, n.reportAllChanges);
              var v = h((function() {
                R[i.id] || (a(p.takeRecords()), p.disconnect(), R[i.id] = !0, t(!0))
              }));
              ["keydown", "click"].forEach((function(e) {
                ...
                i = s("LCP"), t = f(e, i, x, n.reportAllChanges), l((function() {
                  i.value = performance.now() - r.timeStamp, R[i.id] = !0, t(!0)
                }))
              }))
            }
          }))
      ...
      const s = (e = "") => "/" === e ? "" : e,
        ...
        b = ({
          ...
          for (let e in r) {
            ...
            f === p && t !== p[e] && (u.current = p = {
              ...p
            }), p[e] = t, t !== r[e] && (i = p)
          }
          return (0, a.n)(d.Provider, {
            value: i,
            children: e
          })
        },
        ...
        _ = ((0, o.f)(((e, n) => {
          const t = h(),
            ...
            E = t.hrefs("~" === s[0] ? s.slice(1) : t.base + s, t);
          return f && (0, a.zO)(l) ? (0, a.Ob)(l, {
            onClick: y,
            href: E
          }) : (0, a.n)("a", {
            ...m,
        ...
        C = ({
          ...
          for (const i of _(e)) {
            let e = 0;
            if ((0, a.zO)(i) && (e = E(t.parser, i.props.path, n || r, i.props.nest))[0]) return (0, a.Ob)(i, {
              match: e
            })
          }
          return null
...
//# sourceMappingURL=client~768~0b07e8d64b86afacef78.js.map