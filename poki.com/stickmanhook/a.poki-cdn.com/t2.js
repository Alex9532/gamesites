! function() {
  ...
  l && l.clientWidth && l.clientHeight && ("CSS1Compat" === u || !s) ? r.size = l.clientWidth + "x" + l.clientHeight : r.size = c.clientWidth + "x" + c.clientHeight;
  let p = null,
    v = !1;
  ...
  function y() {
    window.__tcfapi && !v && (window.__tcfapi("addEventListener", 2, ((e, t) => {
      !t || "tcloaded" !== e.eventStatus && "useractioncomplete" !== e.eventStatus || k(e)
  ...
  function m(e) {
    return Object.keys(e).forEach((t => {
      if (!g[t]) return console.error("unknown field ".concat(t)), void delete e[t];
      if (Array.isArray(e[t])) {
        if (0 === e[t].length) return void delete e[t];
        for (let a = 0; a < e[t].length; a++) e[t][a] = m(e[t][a])
      } else {
        if (null === e[t] || void 0 === e[t]) return void delete e[t];
        "object" == typeof e[t] && m(e[t])
      }
      const a = g[t];
  ...
  let f = !1;
  const w = ["AT", "BE", "BG", "CH", "CY", "CZ", "DE", "DK", "ES", "EE", "FI", "FR", "GR", "HR", "HU", "IE", "IS", "IT", "LI", "LT", "LU", "LV", "MT", "NL", "NO", "PL", "PT", "RO", "SK", "SI", "SE", "GB"];
  ...
  function A() {
    return (void 0 === window.pokiBingRemarketing || window.pokiBingRemarketing) && (window.pokiCountry && !w.includes(window.pokiCountry) || f)
  }

  function h() {
    return (void 0 === window.pokiGoogleRemarketing || window.pokiGoogleRemarketing) && (window.pokiCountry && !w.includes(window.pokiCountry) || f)
  }
  const I = "AW-962655633";
  ...
  function _() {
    ...
    t.src = "https://www.googletagmanager.com/gtag/js?id=".concat(I);
  ...
  function D(e) {
    _(), window.gtag("event", "conversion", {
      send_to: "".concat(I, "/").concat(e),
      value: 1,
      currency: "USD"
    })
  }
  ...
  function M(e) {
    const t = i();
    if (!t) return;
    E = performance.now(), P && clearInterval(P);
    const a = t.gameplayTotalTime || 0;
    a <= C && (P = setTimeout((() => {
      if (t.gclid && h() && (S() ? D("1RivCPGb38gBEJHrg8sD") : T() ? D("nA26CIzb3qQBEJHrg8sD") : D("Q-g4CKu_36QBEJHrg8sD")), A()) {
        N();
        let t = "desktop";
        S() ? t = "mobile" : T() && (t = "tablet");
        let a = !1;
  ...
  function R() {
    E && (d((e => {
      e.gameplayTotalTime = (e.gameplayTotalTime || 0) + (performance.now() - E)
    })), E = void 0), P && clearInterval(P)
  }
  ...
  window.addEventListener("visibilitychange", (() => {
    H = "visible" === document.visibilityState
  }));
  let U = !1;
  ...
  function x(e, a, n) {
    ...
    if ("pageview" === a && !v.site.id) return;
    ...
    let b, A = null === (o = e.content) || void 0 === o || null === (o = o.pokifordevs) || void 0 === o ? void 0 : o.game_id,
      h = null === (r = e.content) || void 0 === r || null === (r = r.pokifordevs) || void 0 === r ? void 0 : r.game_version_id;
    A || ({
      gameID: A
    } = e), h || (h = e.gameVersion), v.site.id || "pubhost" !== a || "initialized" !== n ? "pageview" !== a || U || (U = !0, ({
      referrer: b
    } = document)) : ({
      referrer: b
    } = document);
    let I = 0;
    k.expire && (I = Math.ceil((k.expire - Date.now()) / 1e3)), m && "pageview" !== a || (p.interaction && d((function(e) {
  ...
  function q(a) {
    ...
    try {
      if ("sdk-message" === o)
        if ("pokiTrackingScreenDisplayAdImpression" === i.content.event) x(i, "ad", "displayImpression", i.content.data.platformAd ? "platform" : "ingame", [{
          key: "opportunityId",
        ...
        else if ("pokiTrackingScreenDisplayAdRequested" === i.content.event) x(i, "ad", "displayRequest", i.content.data.platformAd ? "platform" : "ingame", [{
        key: "opportunityId",
        value: i.content.data.opportunityId
      }, {
        key: "adUnitPath",
        ...
        if ("pokiTrackingScreenDisplayAdDestroy" === i.content.event && i.content.data.platformAd) x(i, "platform", "destroyAd", "", [{
          key: "opportunityId",
          value: i.content.data.opportunityId
        }]);
        else if ("pokiTrackingScreenGameLoadingFinished" === i.content.event) x(i, "game", "loadingFinished", "", [{
        key: "time_on_page",
        ...
        var r;
        x(i, "game", "play", "start", G(i.content.data), {
          interaction: !0
        }), M(null === (r = n.page) || void 0 === r || null === (r = r.content) || void 0 === r || null === (r = r.game) || void 0 === r ? void 0 : r.id)
      } else if ("pokiTrackingScreenGameplayStop" === i.content.event) R(), x(i, "game", "play", "stop", G(i.content.data), {
        interaction: !0
      });
      else if ("pokiTrackingAdsStatusError" === i.content.event) x(i, "ad", "error", "", [{
        key: "opportunityId",
        value: i.content.data.opportunityId
      }, {
        key: "adBreakId",
        value: i.content.data.adBreakId
      }, {
        key: "currentAdNumber",
        value: i.content.data.currentAdNumber
      }, {
        key: "totalAdAmount",
        value: i.content.data.totalAdAmount
      }, {
        key: "waterfall",
        value: i.content.data.waterfall
      }]);
      else if ("pokiTrackingSdkStatusFailed" === i.content.event) x(i, "ad", "failed", "", [{
        key: "opportunityId",
        value: i.content.data.opportunityId
      }, {
        key: "adBreakId",
      ...
      else if ("pokiTrackingAdsStatusBuffering" === i.content.event) x(i, "ad", "videoBuffering", W(i), [{
        key: "waterfall",
        value: i.content.data.waterfall
      }, {
        key: "opportunityId",
      ...
      else if ("pokiTrackingAdsVideoError" === i.content.event) x(i, "ad", "videoError", W(i), [{
        key: "waterfall",
        value: i.content.data.waterfall
      }, {
        key: "opportunityId",
        ...
        value: i.content.data.HBDetectedWinningBidder
      }, {
        key: "hbPrebidWon",
        value: i.content.data.HBPrebidWon
      }, {
        key: "hbAdDomain",
      ...
      else if ("pokiTrackingAdsVideoExtendedVideoError" === i.content.event) x(i, "ad", "videoExtendedError", W(i), [{
        key: "waterfall",
        value: i.content.data.waterfall
      }, {
        key: "opportunityId",
        ...
        key: "vastChain",
        value: i.content.data.vastChain
      }, {
        key: "vastResolved",
        value: i.content.data.vastResolved
      }, {
        key: "vastResolveErr",
        value: i.content.data.vastResolveErr
      }]);
      else if ("pokiTrackingAdsVideoLoaderError" === i.content.event) x(i, "ad", "videoLoaderError", W(i), [{
        key: "waterfall",
        value: i.content.data.waterfall
      }, {
        key: "opportunityId",
      ...
      else if ("pokiTrackingAdsStatusPrebidRequested" === i.content.event) x(i, "ad", "videoPrebidRequested", W(i), [{
        key: "waterfall",
        value: i.content.data.waterfall
      }, {
        key: "opportunityId",
      ...
      else if ("pokiTrackingAdsStatusReady" === i.content.event) x(i, "ad", "videoReady", W(i), [{
        key: "waterfall",
        value: i.content.data.waterfall
      }, {
        key: "opportunityId",
      ...
      else if ("pokiTrackingAdsStatusSkipped" === i.content.event) x(i, "ad", "videoSkipped", W(i), [{
        key: "waterfall",
        value: i.content.data.waterfall
      }, {
        key: "opportunityId",
      ...
      else if ("pokiTrackingAdsVideoClicked" === i.content.event) x(i, "ad", "videoClicked", W(i), [{
        key: "waterfall",
        value: i.content.data.waterfall
      }, {
        key: "opportunityId",
      ...
      else if ("pokiTrackingAdsStatusCompleted" === i.content.event) x(i, "ad", "videoCompleted", W(i), [{
        key: "waterfall",
        value: i.content.data.waterfall
      }, {
        key: "opportunityId",
        ...
        var l, c;
        if (h()) null === (l = window) || void 0 === l || null === (c = l.gtag) || void 0 === c || c.call(l, "event", "conversion", {
          send_to: "AW-962655633/FPkKCJ6c7KQBEJHrg8sD",
          value: 0,
          currency: "MXN"
        })
      } else if ("pokiTrackingAdsVideoPaused" === i.content.event) x(i, "ad", "videoPaused", W(i), [{
        key: "waterfall",
        value: i.content.data.waterfall
      }, {
        key: "opportunityId",
      ...
      else if ("pokiTrackingAdsStatusRequested" === i.content.event) x(i, "ad", "videoRequest", W(i), [{
        key: "waterfall",
        value: i.content.data.waterfall
      }, {
        key: "opportunityId",
      ...
      else if ("pokiTrackingAdsVideoResumed" === i.content.event) x(i, "ad", "videoResumed", W(i), [{
        key: "waterfall",
        value: i.content.data.waterfall
      }, {
        key: "opportunityId",
      ...
      else if ("pokiTrackingAdsStatusStarted" === i.content.event) x(i, "ad", "videoStarted", W(i), [{
        key: "waterfall",
        value: i.content.data.waterfall
      }, {
        key: "opportunityId",
      ...
      else if ("pokiTrackingRewardedWebRequest" === i.content.event) x(i, "ad", "rewardedWeb", "request", [{
        key: "opportunityId",
        value: i.content.data.opportunityId
      }]);
      else if ("pokiTrackingRewardedWebReady" === i.content.event) x(i, "ad", "rewardedWeb", "ready", [{
        key: "opportunityId",
        value: i.content.data.opportunityId
      }]);
      else if ("pokiTrackingRewardedWebImpression" === i.content.event) x(i, "ad", "rewardedWeb", "impression", [{
        key: "opportunityId",
        value: i.content.data.opportunityId
      }, {
        key: "adUnitPath",
      ...
      else if ("pokiTrackingRewardedWebClosedGranted" === i.content.event) x(i, "ad", "rewardedWeb", "closedGranted", [{
        key: "opportunityId",
        value: i.content.data.opportunityId
      }]);
      else if ("pokiTrackingRewardedWebClosedDeclined" === i.content.event || "pokiTrackingRewardedWebclosedDeclined" === i.content.event) x(i, "ad", "rewardedWeb", "closedDeclined", [{
        key: "opportunityId",
        value: i.content.data.opportunityId
      }]);
      else if ("pokiTrackingRewardedWebEmpty" === i.content.event) x(i, "ad", "rewardedWeb", "empty", [{
        key: "opportunityId",
        value: i.content.data.opportunityId
      }]);
        ...
        var u, s;
        const e = h();
        if (x(i, "game", "play", "first", [{
            key: "hasGoogleConsent",
            value: e
          }], {
            interaction: !0,
            once_per_pageview: !0
          }), M(null === (u = n.page) || void 0 === u || null === (u = u.content) || void 0 === u || null === (u = u.game) || void 0 === u ? void 0 : u.id), "GB" === n.geo) return;
        const t = null === (s = n.page) || void 0 === s || null === (s = s.content) || void 0 === s || null === (s = s.game) || void 0 === s ? void 0 : s.id;
        let a = !1;
        if (window.api && window.api.getAdblock && (a = window.api.getAdblock()), A()) {
          N();
          let e = "desktop";
          S() ? e = "mobile" : T() && (e = "tablet"), window.uetq.push("event", "game-play-first", {
            event_category: e,
            event_label: t,
            event_value: a ? 1 : 0
        ...
        e && (D("KzjDCPH3l6IBEJHrg8sD"), D("YAozCMbHmZQDEJHrg8sD"), S() ? (D("GcnkCL2-mZQDEJHrg8sD"), D("yoVJCODb6pMDEJHrg8sD")) : T() ? (D("LpAFCNHG6pMDEJHrg8sD"), D("NC5BCKnU6pMDEJHrg8sD")) : (D("tmXGCPitoJQDEJHrg8sD"), D("vjKvCO35q4cDEJHrg8sD"), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) ? D("AT-CCLLI3qQBEJHrg8sD") : D("XuGfCNXE3qQBEJHrg8sD")))
      } else if ("pokiTrackingScreenCommercialBreak" === i.content.event) x(i, "game", "commercialBreak", "", [{
        key: "opportunityId",
        value: i.content.data.opportunityId
      }, {
        key: "adBreakId",
      ...
      else if ("pokiTrackingScreenRewardedBreak" === i.content.event) x(i, "game", "rewardedBreak", "", [{
        key: "opportunityId",
        value: i.content.data.opportunityId
      }, {
        key: "adBreakId",
      ...
      else if ("SaveGameMigrator" === i.type && "error" === i.content.event) x(i, "game", "saveGameMigrator", "error", [{
        key: "error",
        value: i.content.error
      }]);
      else if ("SaveGameMigrator" === i.type && "start" === i.content.event) x(i, "game", "saveGameMigrator", "start");
      else if ("SaveGameMigrator" === i.type && "timeout" === i.content.event) x(i, "game", "saveGameMigrator", "timeout");
      else if ("pokiTrackingSdkStatusInitialized" === i.content.event) x(i, "game", "sdkInitialized", "", [], {
        once_per_pageview: !0
      });
      else if ("pokiTrackingScreenDisplayAdRequest" !== i.content.event || i.content.data.platformAd)
        if ("pokiTrackingScreenDisplayAdRequest" === i.content.event && i.content.data.platformAd) x(i, "platform", "displayAd", "", [{
          key: "opportunityId",
          value: i.content.data.opportunityId
        }, {
          key: "size",
        ...
        else if ("pokiTrackingCustom" === i.content.event) x(i, i.content.data.category || i.content.data.eventNoun, i.content.data.action || i.content.data.eventVerb, "", G(i.content.data.eventData || {}));
      ...
      } else if ("pokiTrackingScreenPlayerActive" === i.content.event) x(i, "game", "playerActive", "", [], {
        interaction: !0
      });
      else if ("pokiTrackingPlaytestShowModal" === i.content.event) x(i, "playtest", "showModal", "", [{
        key: "show",
        value: i.content.data.show
      }]);
      else if ("pokiTrackingPlaytestAccepted" === i.content.event) x(i, "playtest", "accepted", "", [], {
        interaction: !0
      });
      else if ("pokiTrackingPlaytestRejected" === i.content.event) x(i, "playtest", "rejected", "", [], {
        interaction: !0
      });
      else if ("pokiTrackingPlaytestNoCanvas" === i.content.event) x(i, "playtest", "noCanvas", "", []);
      else if ("pokiTrackingPlaytestStarting" === i.content.event) x(i, "playtest", "starting", "", []);
      else if ("pokiTrackingPlaytestClosed" === i.content.event) x(i, "playtest", "closed", "", [{
        key: "reason",
        value: i.content.data.reason
      }]);
      else if ("pokiTrackingPlaytestError" === i.content.event) x(i, "playtest", "error", "", [{
        key: "message",
        value: i.content.data.message
      }]);
      else if ("pokiTrackingAdsAYFailed" === i.content.event) x(i, "ay", "failed", "", [{
        key: "reason",
        value: i.content.data.reason
      }, {
        key: "ayMode",
        value: i.content.data.ayMode
      }, {
        key: "gptRejected",
        value: i.content.data.gptRejected
      }, {
        key: "imaRejected",
        value: i.content.data.imaRejected
      }, {
        key: "prebidRejected",
        value: i.content.data.prebidRejected
      }, {
        key: "a9Rejected",
        value: i.content.data.a9Rejected
      }, {
        key: "displayOnly",
        value: i.content.data.displayOnly
      }, {
        key: "fullStack",
        value: i.content.data.fullStack
      }]);
      else if ("pokiTrackingAdsDebugging" === i.content.event) {
        const {
          category: e,
          action: t,
          label: a,
        ...
        if ("" === e || "" === t) return;
        x(i, e, t, a, [Object.entries(n).map((e => {
          let [t, a] = e;
          return {
            key: t,
            value: a
      ...
      } else "pokiTrackingAdsDisplayNotFilled" === i.content.event && x(i, "ad", "unfilled", "", [{
        key: "bidder",
        value: i.content.data.bidder
      }, {
        key: "cpm",
        value: i.content.data.cpm
      }, {
        key: "adUnitPath",
        value: i.content.data.adUnitPath
      }, {
      ...
      else x(i, "game", "destroyAd", "ingame", [{
        key: "opportunityId",
        value: i.content.data.opportunityId
      }]);
      else if ("adslot-renderEnded" === o) x(i, "ad", "displayImpression", "platform", [{
        key: "trigger",
        value: i.refreshType
      }, {
        key: "adUnitPath",
      ...
      else if ("ads-adblocked" === o) x(i, "ad", "adblocked", "platform", [{
        key: "playground",
        value: i.playground
      }, {
        key: "sdk",
      ...
      else if ("ads-notFound" === o) x(i, "ad", "notFound", "platform", [{
        key: "event",
        value: i.event
      }, {
        key: "code",
      ...
      else if ("ads-render" === o) x(i, "ad", "displayRequest", "platform", [{
        key: "trigger",
        value: i.refreshType
      }, {
        key: "adUnitPath",
      ...
      else if ("housead-click" === o) x(i, "ad", "houseAdClick", "platform", [{
        key: "houseAdId",
        value: i.houseAdId
      }]);
      else if ("consent-full" === o) b(!0), B(!0), x(i, "consent", "full"),
        function(e) {
          if ("GB" !== e.geo) {
      ...
      else if ("consent-no" === o) b(!1), B(!1), x(i, "consent", "no");
      ...
      } else if ("consent-npa" === o) x(i, "consent", "npa");
      else if ("consent-unknown" === o) x(i, "consent", "unknown");
      else if ("consent-bootError" === o) x(i, "consent", "bootError");
      else if (o.startsWith("rating-")) x(i, "game", "rating", o.substr(13).toLowerCase(), [{
        key: "previous_vote",
        value: i.previousVote
      }], {
        interaction: !0
      });
      else if ("sdk-details" === o) x(i, "game", "sdkDetails", "", [{
        key: "version",
        value: i.version
      }], {
        once_per_pageview: !0
        ...
        const e = [{
          ...
          key: "playground",
          value: null == i ? void 0 : i.playground
        }, {
          key: "sdk",
          value: null == i ? void 0 : i.sdk
        }, {
          key: "ayMode",
          value: null == i ? void 0 : i.ayMode
        }, {
          key: "sessionRandom",
          value: n.session.random
        }];
        ...
        const t = () => {
          x(i, "page", "reactPrehydrate", n.page.type, e)
        };
        try {
      ...
      } else if ("tile-click" === o) i.searchExpanded ? x(i, "search", "tileClick", n.page.type, [{
        key: "id",
        value: i.id
      }, {
        key: "type",
        ...
        interaction: !0
      }) : x(i, "page", "tileClick", n.page.type, [{
        key: "id",
        value: i.id
      }, {
        key: "type",
        ...
        var p, v;
        x(i, "pubhost", "initialized", "", [{
          key: "topOrigin",
          value: i.topOrigin
        }, {
          key: "bot.verified",
          value: null === (p = i.bot) || void 0 === p ? void 0 : p.verified
        }, {
          key: "bot.score",
          value: null === (v = i.bot) || void 0 === v ? void 0 : v.score
        }])
        ...
        if ((30 === t && a < 30 || 60 === t && a < 60 || 120 === t && a < 120 || 300 === t && a < 300 || 600 === t && a < 600 || 1200 === t && a < 1200 || 1800 === t && a < 1800) && x(i, "page", "timeSpent", "".concat(t, "s"), [{
            key: "visible",
            value: H ? "1" : "0"
          }]), "GB" === n.geo) return;
        if (e >= 300 && e < 330) {
          if (A() && "game" === n.page.type) {
            var k;
            N();
            const e = null === (k = n.page) || void 0 === k || null === (k = k.content) || void 0 === k || null === (k = k.game) || void 0 === k ? void 0 : k.id;
            let t = !1;
            window.api && window.api.getAdblock && (t = window.api.getAdblock());
            let a = "desktop";
            S() ? a = "mobile" : T() && (a = "tablet"), window.uetq.push("event", "page_timeSpent-300", {
              event_category: a,
              event_label: e,
              event_value: t ? 1 : 0
            })
          }
          "game" === n.page.type && h() && (y = n.user.id, g = n.page.id, _(), window.gtag("event", "page_view", {
            send_to: I,
            user_id: y,
            value: 0,
            items: [{
          ...
          }), D("2IEyCPmFmZQDEJHrg8sD"), S() ? D("AYEACNah6pMDEJHrg8sD") : T() ? D("y05mCNeWmZQDEJHrg8sD") : D("lsPJCLbOqYEBEJHrg8sD"))
        } else e >= 900 && e < 930 && "game" === n.page.type && h() && (S() ? D("t5VrCLXIlMkBEJHrg8sD") : T() ? D("WUfoCMSC5LkBEJHrg8sD") : D("Gh96CL-84MkBEJHrg8sD"))
      } else if ("appStoreButton-click" === o) x(i, "game", "appstoreClick", i.store, [], {
        interaction: !0
      });
      else if ("home-click" === o) x(i, "home", "click", n.page.type, [], {
        interaction: !0
      });
      else if ("logo-click" === o) x(i, "logo", "click", n.page.type, [], {
        interaction: !0
      });
      else if ("fullscreenButton-click" === o) x(i, "fullscreenButton", "click", "", [{
        key: "targetState",
        value: i.targetState
      }], {
        interaction: !0
      });
      else if ("page-pillClick" === o) x(i, "page", "pillClick", "", [], {
        interaction: !0
      });
      else if ("page-pillDrag" === o) x(i, "page", "pillDrag", "", [{
        key: "x",
        value: i.x
      }, {
        key: "y",
      ...
      else if ("page-autoRedirectClick" === o) x(i, "page", "autoRedirect", "click", [], {
        interaction: !0
      });
      else if ("searchPanel-close" === o) x(i, "searchPanel", "close", n.page.type, [{
        key: "searchSessionId",
        value: i.searchSessionId
      }], {
        interaction: !0
      });
      else if ("searchPanel-open" === o) x(i, "searchPanel", "open", n.page.type, [{
        key: "searchSessionId",
        value: i.searchSessionId
      }], {
        interaction: !0
      });
      else if ("game-launch" === o) x(i, "game", "launch", "", [], {
        interaction: !0
      });
        ...
        null != o && o.pageTypeAsLabel && (d = n.page.type), x(i, e, t, d, G(i), o)
      } else {
        const e = [];
        void 0 === i.counter && window.pokiBotDetected && e.push({
            key: "bot",
  ...
  const J = window;
  J._pokiTrackerGlobalName = J._pokiTrackerGlobalName || "tracker", J[J._pokiTrackerGlobalName] = J[J._pokiTrackerGlobalName] || [];
  const z = J[J._pokiTrackerGlobalName];
  for (z.uniqueEvents = {}, z.firstPageview = !0, z.installTCFHandler = y, z.push = function(e, a, n, o, i, d) {
      return r => {
        if ("function" != typeof r) try {
          ...
          r.insert_id = o(), r = m(r), n("https://t.poki.io/t", JSON.stringify(r)), "pageview" === r.category && (a.firstPageview = !1)
        } catch (e) {
          t(e, "push")
        } else r()
      }
